...
class PersonalInfoEditContentWidget extends StatefulWidget {
  const PersonalInfoEditContentWidget({super.key, required this.state});

  final PersonalInfoState state;

  @override
  State<PersonalInfoEditContentWidget> createState() =>
      _PersonalInfoEditContentWidgetState();
}

class _PersonalInfoEditContentWidgetState
    extends State<PersonalInfoEditContentWidget> {
  ...
  void initState() {
    ...
    _phoneController =
        TextEditingController(text: widget.state.draftPhoneNumber);
